...
public class PlayerDataManager {
    ...
    public PlayerData createAccount(UUID uuid, String name) {
        ...
        return new PlayerData(uuid, name, new PlayerRank(ElysiumRanks.HININ, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis())), 1000, 0, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()));
    }
}