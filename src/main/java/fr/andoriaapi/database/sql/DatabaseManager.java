...
public enum DatabaseManager {
    ...
    PLAYERS(new DatabaseConnector("localhost", "root", "Champagne2003@", "andoriaplayers", 3306)),
    FACTIONS(new DatabaseConnector("localhost", "root", "Champagne2003@", "andoriafactions", 3306)),
    SANCTIONS(new DatabaseConnector("localhost", "root", "Champagne2003@", "andoriasanctions", 3306));
